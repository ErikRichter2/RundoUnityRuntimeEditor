...
namespace Rundo.RuntimeEditor.Behaviours
{
    public class DefaultDataListInspectorBehaviour : InspectorBaseBehaviour
    {
        ...
        [SerializeField] private ExpandCollapseButtonBehaviour _expandCollapseButtonBehaviour;
        ...
        private void ProcessListElement(int index)
        {
            ...
            // handle primitives
            var uiDataMapperElement = UiDataMapper.Create(_currentType, "");
            ...
            var inspector = UiElementsFactory.InstantiateInspectorPrefab(_currentType, _content);
            inspector.SetData(dataHandler, "");
        }
    }
}
