...
namespace Rundo.Core.Data
{
    public class ReflectionService
    {
        ...
        private readonly Dictionary<Type, Type> _uiDataMapperElements = new Dictionary<Type, Type>();
        ...
        private void Init()
        {
            ...
            foreach (var type in assembly.GetTypes())
            {
                ...
                var uiDataMapperElementAttr = type.GetCustomAttribute<UiDataMapperElementAttribute>();
                if (uiDataMapperElementAttr != null)
                {
                    _uiDataMapperElements[uiDataMapperElementAttr.Type] = type;
                }
        ...
        public Type GetTypeForUiDataMapperElementType(Type type)
        {
            Init();
            if (_uiDataMapperElements.TryGetValue(type, out var uiDataMapperElementType))
                return uiDataMapperElementType;
            return default;
        }
